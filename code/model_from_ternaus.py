...
class ComplexAlbuNet(nn.Module):
    """
        UNet (https://arxiv.org/abs/1505.04597) with Resnet34(https://arxiv.org/abs/1512.03385) encoder
        Proposed by Alexander Buslaev: https://www.linkedin.com/in/al-buslaev/
        """
    ...
    def __init__(self, num_classes=1, num_filters=32, pretrained=False, is_deconv=False):
        ...
        self.dec1 = DecoderBlock(num_filters * 2 * 2, num_filters * 2 * 2, num_filters, is_deconv)
        self.dec0 = ConvRelu(num_filters, num_filters)
        self.final = nn.Sequential(ConvRelu(num_filters,num_filters),nn.Conv2d(num_filters, num_classes, kernel_size=1))
...
class SuperLabelAlbuNet(nn.Module):
    """
        UNet (https://arxiv.org/abs/1505.04597) with Resnet34(https://arxiv.org/abs/1512.03385) encoder
        Proposed by Alexander Buslaev: https://www.linkedin.com/in/al-buslaev/
        """

    def __init__(self, num_super_class = 1, num_classes=1, num_filters=32, pretrained=False, is_deconv=False, super2sub = [[0]]):
        """
        :param num_classes:
        :param num_filters:
        :param pretrained:
        ...
        self.dec1 = DecoderBlock(num_filters * 2 * 2, num_filters * 2 * 2, num_filters, is_deconv)
        self.dec0 = ConvRelu(num_filters, num_filters)
        self.super_class_classifier = nn.Conv2d(num_filters, num_super_class, kernel_size=1)
        self.final_classifier = nn.Conv2d(num_filters, num_classes, kernel_size=1)
    ...
    def forward(self, x):
        ...
        #     x_out = F.log_softmax(self.final(dec0), dim=1)
        # else:
        super_class_out = F.softmax(self.super_class_classifier(dec0), dim=1)
        score_out = F.softmax(self.final_classifier(dec0), dim=1)
