...
#             print("distort 1")
            ...
            k = random.uniform(-self.distort_limit, self.distort_limit) * 0.00005
...
#             *(
#                 OneOf([
#                     Distort1(distort_limit=0.35, shift_limit=0.25),
...
#                 ImageOnly(RandomNoise(p=0.8, bias=True)),
#             ])(x, mask)
    return DualCompose([
...
#                Distort2(num_steps=2, distort_limit=0.2),
        ...
        OneOf([ImageOnly(RandomContrast(limit=0.2, prob=0.8)),
              ImageOnly(RandomFilter(limit=0.5, prob=0.8)),
              ImageOnly(RandomNoise(p=0.8, bias=True)),])
